          ...
          {isClient && (
            <>
              <button
                ...
                className="absolute left-2 top-1/2 -translate-y-1/2 bg-gradient-to-r from-purple-500 to-pink-500 text-white p-3 rounded-full shadow-md hover:from-purple-600 hover:to-pink-600 transition-all z-10"
              ...
              <button
                onClick={goToNext}
                className="absolute right-2 top-1/2 -translate-y-1/2 bg-gradient-to-r from-purple-500 to-pink-500 text-white p-3 rounded-full shadow-md hover:from-purple-600 hover:to-pink-600 transition-all z-10"
